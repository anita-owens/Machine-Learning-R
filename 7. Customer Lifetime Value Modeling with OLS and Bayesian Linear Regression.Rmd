...
# Create test
test <- df_grouped[(split + 1):nrow(df_outliers_removed),]
```
...
Our r-squared actually did not move that much, but now we get different coefficients
which does change our interpretations and our forecasts for the CLV.
