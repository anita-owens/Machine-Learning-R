...
```{r Load file}
oreos <- read.xlsx("/Users/anitaowens/Documents/Marketing Analytics-Data Driven Techniques with Excel/Excel Files/Chapter 10 Excel Files/Oreos.xlsx", skipEmptyRows = TRUE)
```
